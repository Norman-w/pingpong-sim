...
export const SHOT_PRESETS: readonly ShotPreset[] = [
  ...
  // nearer, some deeper. Horizontal speed must reach deep first-bounce targets;
  // too-soft lobs leave a second bounce on the table. Mild topspin adds end-line carry.
  { id: 'lob', name: '高吊球', category: '基础球', description: '高弧线、中低速，落点偏中深；一跳后前冲出台，便于高点扣杀。', speedMps: 4.8, topRpm: 1600, sideRpm: 0, corkRpm: 0, targetDepthMm: 2300, launchHeightMm: 1120, cadence: 0.75, spreadMm: 160, color: orange },
